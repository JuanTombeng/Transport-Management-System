...
;(function (factory) {
	if ( typeof define === 'function' && define.amd ) {
		...
		define(['booking/templates/booking/jquery', 'jquery-mousewheel'], factory);
	} else if (typeof exports === 'object') {
		// Node/CommonJS style for Browserify
		module.exports = factory(require('booking/templates/booking/jquery'));;
	} else {
		// Browser globals
		factory(jQuery);
	}
...
(function (factory) {
    if ( typeof define === 'function' && define.amd ) {
        // AMD. Register as an anonymous module.
        define(['booking/templates/booking/jquery'], factory);
    } else if (typeof exports === 'object') {
        // Node/CommonJS style for Browserify
